    ...
    const checkAuth = async () => {
      try {
        ...
        if (profile && profile.role === "farmer") {
          ...
          // Check if session exists in localStorage saved profile
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "#f3faf4" }}>
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        <header className="sticky top-0 z-20 flex items-center justify-between px-4 py-3 bg-white/90 backdrop-blur border-b border-agri-100">
          <div className="flex items-center gap-3">
            <button
              onClick={() => setOpen(true)}
              className="lg:hidden p-2 rounded-xl bg-agri-50 text-agri-800"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-[#edf9f0] border border-[#a7e4b0] text-xs font-black text-[#2e7d3a] hover:bg-[#d4f2d9] transition cursor-pointer shadow-sm"
          >
