        ...
        <div className="p-6">
          ...
          <div className="mt-4 flex gap-3">
            ...
            <button
              onClick={async () => {
                try {
                  const newOrder = await farmerApi.createOrder(lot.id, `off-direct-${lot.id}`)
              ...
              className="px-5 py-3 rounded-2xl border-2 border-agri-200 font-bold bg-agri-600 text-white hover:bg-agri-700 transition"
            >
              Buy Lot
            </button>
          </div>
