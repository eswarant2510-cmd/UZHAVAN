...
export function runDecisionEngine(
  ...
  offers.forEach((o) => {
    vehicles.forEach((v) => {
      ...
      const computedCost = v.estimatedCost ?? Math.round(v.baseCost + o.distanceKm * v.costPerKm)
  ...
  vehicles.forEach((v) => {
    ...
    const computedCost = v.estimatedCost ?? Math.round(v.baseCost + marketDistance * v.costPerKm)
